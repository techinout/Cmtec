  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="table-wrapper">
        <div class="table-title">
            <div class="row">
                <div class="col-xs-5">
                    <h2>Gerenciamento de <b>Equipamentos</b></h2>
                </div>
            </div>
        </div>
        <table id="equipamentosTable" class="table table-striped table-hover">
            ...
            <tbody>
                <?php foreach ($equipamentos as $equipamento): ?>
                    <tr>
                        <td><?php echo htmlspecialchars($equipamento['codEquipamentos']); ?></td>
                        <td><?php echo htmlspecialchars($equipamento['descricao']); ?></td>
                        <td class="actions">
                            <!-- Botão de Editar -->
                            <a href="#" class="fa fa-edit" title="Editar" data-toggle="modal" data-target="#editModal<?php echo $equipamento['codEquipamentos']; ?>"></a>

                            <!-- Botão de Deletar -->
                            <a href="../../../DAO/equipamento/equipamentoDelete.php?id=<?php echo htmlspecialchars($equipamento['codEquipamentos']); ?>" class="fa fa-trash" title="Excluir" data-toggle="tooltip" onclick="return confirm('Tem certeza que deseja excluir este equipamento?');"></a>
                            
                            <!-- Modal de Edição -->
                            <div class="modal fade" id="editModal<?php echo $equipamento['codEquipamentos']; ?>" tabindex="-1" role="dialog" aria-labelledby="editModalLabel<?php echo $equipamento['codEquipamentos']; ?>" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="editModalLabel<?php echo $equipamento['codEquipamentos']; ?>">Editar Equipamento</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <div class="modal-body">
                                            <form action="../../../DAO/equipamento/equipamentoPatch.php" method="post">
                                                <div class="form-group mb-4">
                                                    <label for="descricao<?php echo $equipamento['codEquipamentos']; ?>">Descrição</label>
                                                    <input type="text" class="form-control" id="descricao<?php echo $equipamento['codEquipamentos']; ?>" name="descricao" value="<?php echo htmlspecialchars($equipamento['descricao']); ?>">
                                                </div>
                                                <input type="hidden" name="codEquipamentos" value="<?php echo $equipamento['codEquipamentos']; ?>">
        ...
        <div class="clearfix">
            <button type="button" class="btn btn-primary mt-3 w-100" data-toggle="modal" data-target="#addEquipamentoModal">Adicionar Equipamento</button>
            <div class="hint-text mt-2">Mostrando <b><?php echo count($equipamentos); ?></b> registros</div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="addEquipamentoModal" tabindex="-1" role="dialog" aria-labelledby="addEquipamentoModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addEquipamentoModalLabel">Adicionar Equipamentos</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="../../../DAO/equipamento/equipamentoPost.php" method="post">
                    <div class="form-group mb-4">
                        <label for="descricaoNovo">Nome do Equipamento</label>

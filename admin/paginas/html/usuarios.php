...
$sql = "SELECT codAluno, nome, email , status FROM Aluno";
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <tbody>
        <?php foreach ($alunos as $aluno): ?>
            <tr>
                <td><?php echo htmlspecialchars($aluno['codAluno']); ?></td>
                <td><?php echo htmlspecialchars($aluno['nome']); ?></td>
                <td><?php echo htmlspecialchars($aluno['email']); ?></td>
                <td><?php echo htmlspecialchars($aluno['status'] == 1 ? 'ATIVO' : 'BLOQUEADO'); ?></td> <!-- Verifica se status é 1 -->
                <td class="actions">
                    <a href="../../../DAO/aluno/alunoDelete.php?id=<?php echo htmlspecialchars($aluno['codAluno']); ?>" class="fa fa-trash" title="Excluir" data-toggle="tooltip" onclick="return confirm('Tem certeza que deseja excluir este aluno?');"></a>
                    <a href="../../../DAO/aluno/alunoBlock.php?id=<?php echo htmlspecialchars($aluno['codAluno']); ?>" class="fa fa-ban" title="Bloquear" data-toggle="tooltip" onclick="return confirm('Tem certeza que deseja bloquear este aluno?');"></a>
                </td>
            </tr>
        <?php endforeach; ?>
    </tbody>
...
<div class="clearfix">
    <div class="hint-text">Mostrando <b><?php echo count($alunos); ?></b> registros</div>
</div>
  ...
  <script src="../assets/js/dashboard.js"></script>
   <!-- Scripts -->
   <script src="assets/js/usuario.js" type="module"></script>
